...
task :snapcraft do
  ...
  Dir.chdir('build') do
    ...
    sh 'snapcraft clean --use-lxd || true'
    sh 'snapcraft --debug --use-lxd'
    sh 'lxc file push /home/jenkins-slave/workspace/kde-frameworks-5-91-qt-5-15-3-core20-release_amd64.snap/sdk_wrapper.sh snapcraft-kde-frameworks-5-qt-5-15-3-core20-sdk/'
    sh 'lxc file push /home/jenkins-slave/workspace/kde-frameworks-5-91-qt-5-15-3-core20-release_amd64.snap/sdk_wrapper.rb snapcraft-kde-frameworks-5-qt-5-15-3-core20-sdk/'
    sh 'snapcraft --debug --use-lxd'
