...
task :snapcraft do
  ...
  sh 'ls'
  sh 'ls ' + Dir.home
  sh 'ls ' + Dir.home + '/workspace/kde-frameworks-5-96-qt-5-15-5-core20-release_amd64.snap/'
  Dir.chdir(Dir.home + '/workspace/kde-frameworks-5-96-qt-5-15-5-core20-release_amd64.snap/')
  ...
  sh 'lxc start snapcraft-kde-frameworks-5-96-qt-5-15-5-core20-sdk'
  sh 'mkdir kf5'
  sh 'mkdir kf5-dev'
  sh 'lxc file pull --recursive snapcraft-kde-frameworks-5-96-qt-5-15-5-core20-sdk/root/parts/kf5/stage_packages/ kf5/'
  sh 'lxc file pull --recursive snapcraft-kde-frameworks-5-96-qt-5-15-5-core20-sdk/root/parts/kf5-dev/stage_packages/ kf5-dev/'
