...
task :snapcraft do
  ...
  sh 'ls'
  sh 'ls ' + Dir.home
  sh 'ls ' + Dir.home + '/workspace/kde-frameworks-5-91-qt-5-15-3-core20-release_amd64.snap/'
  Dir.chdir(Dir.home + '/workspace/kde-frameworks-5-91-qt-5-15-3-core20-release_amd64.snap/')
  ...
  Dir.chdir('build') do
    ...
    sh 'snapcraft clean --use-lxd || true'
    sh 'snapcraft --debug --use-lxd'
    sh 'lxc file push /home/jenkins-slave/workspace/kde-frameworks-5-91-qt-5-15-3-core20-release_amd64.snap/sdk_wrapper.sh snapcraft-kde-frameworks-5-91-qt-5-15-3-core20-sdk/'
    sh 'lxc file push /home/jenkins-slave/workspace/kde-frameworks-5-91-qt-5-15-3-core20-release_amd64.snap/sdk_wrapper.rb snapcraft-kde-frameworks-5-91-qt-5-15-3-core20-sdk/'
    sh 'snapcraft --debug --use-lxd'
  ...
  sh 'lxc start snapcraft-kde-frameworks-5-91-qt-5-15-3-core20-sdk'
  sh 'mkdir kf5'
  sh 'mkdir kf5-dev'
  sh 'lxc file pull --recursive snapcraft-kde-frameworks-5-91-qt-5-15-3-core20-sdk/root/parts/kf5/stage_packages/ kf5/'
  sh 'lxc file pull --recursive snapcraft-kde-frameworks-5-91-qt-5-15-3-core20-sdk/root/parts/kf5-dev/stage_packages/ kf5-dev/'
